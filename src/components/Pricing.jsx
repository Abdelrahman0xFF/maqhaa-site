...
const PACKAGES = [
  {
    ...
    tagline: "الأساسية لإدارة القهوة",
    note: "نظام كاشير سهل للمقاهي الصغيرة.",
    cta: "اطلب الآن",
    highlight: false,
    features: [
      "شاشة بيع بسيطة مع بحث باركود",
      "إضافات مثل سكر أو حليب",
  ...
  },
  {
    ...
    tagline: "الكاملة للمطاعم الكبيرة",
    note: "كل ميزات الأساسية + إدارة مخزون وموردين.",
    cta: "اطلب الآن",
    highlight: true,
    features: [
