...
const FAQ = [
  ...
  },
  {
    ...
    a: "الباقة الأساسية تشمل المبيعات والطاولات والفواتير. الباقة Premium تضيف ادارة المخزون، الموردين، وتوجيه الطابعات المتعدد.",
  },
  {
  ...
  },
  {
    ...
    a: "تدعم الطابعات الحرارية 80 مم.",
  },
  {
  ...
  return (
    <section id="faq" aria-label="الأسئلة الشائعة" className="py-20">
      <Container className="max-w-3xl">
        <SectionHeading
          title="أسئلة شائعة"
          description="كل ما تحتاج معرفته عن نظام مقهى."
        />
